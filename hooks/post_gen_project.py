...
def configure_layout_files(ui_library):
    bs_files = [
        "app/views/layouts/horizontal.html.erb",
        "app/views/layouts/vertical.html.erb",
    ]
    tw_files = [
        "app/views/layouts/horizontal-tw.html.erb",
        "app/views/layouts/vertical-tw.html.erb",
        "Procfile.dev"
    ]
